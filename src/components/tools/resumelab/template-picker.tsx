    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        ...
        <span className="text-sm text-slate-500">
          Your credits: <span className="font-semibold text-indigo-600">{userCredits}</span>
        </span>
      </div>
            ...
            >
              ...
              <div className="aspect-[8.5/11] bg-gradient-to-br from-slate-100 to-slate-200 relative">
                ...
                {isHovered && affordable && (
                  <div className="absolute inset-0 bg-indigo-500/10 flex items-center justify-center">
                    <span className="bg-white text-indigo-600 font-medium px-4 py-2 rounded-lg shadow-lg">
              ...
              <div className="p-3 bg-white">
                <div className="flex items-start justify-between">
                  ...
                  <div className="flex items-center space-x-1 text-sm font-semibold text-indigo-600 bg-indigo-50 px-2 py-1 rounded-lg">
                    <span>{template.creditCost}</span>
                    <span className="text-xs text-indigo-400">cr</span>
                  </div>
                </div>
      ...
      {selectedTemplateId && (
        <div className="flex justify-center pt-4">
          <button
            ...
            disabled={loading}
            className="flex items-center space-x-2 bg-gradient-to-r from-indigo-500 to-purple-600 text-white font-semibold px-8 py-3 rounded-xl shadow-lg shadow-indigo-500/30 hover:shadow-xl transition-all disabled:opacity-50"
          >
            {loading ? (
              <>
